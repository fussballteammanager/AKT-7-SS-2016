...
class TPlayer
{
    ...
    public:
        TPlayer();
        TPlayer(string name, string position, short tricotNr, unsigned int NumberOfGames, unsigned int NumberOfPasses, unsigned int NumberOfGoals, unsigned int NumberOfYellowCards, unsigned int NumberOfRedCards, unsigned int Day, unsigned int Month, unsigned int Year);
        virtual ~TPlayer();
